...
-- -----------------------------------------------------
-- Data for table `db_oportunif`.`TB_DOCENTE` 
-- -----------------------------------------------------
START TRANSACTION;
USE `db_oportunif`;
...
INSERT INTO `db_oportunif`.`TB_DOCENTE` (`ID_DOCENTE`, `NOME`, `EMAIL`, `SENHA`, `CHAVE`, `SITUACAO`, `SUPER_USUARIO`) VALUES (14, 'Anderson Ribeiro de Almeida', 'anderson.almeida@ifpr.edu.br', 'def123#&', 'CHAVE123A', 'pendente', 0);
INSERT INTO `db_oportunif`.`TB_DOCENTE` (`ID_DOCENTE`, `NOME`, `EMAIL`, `SENHA`, `CHAVE`, `SITUACAO`, `SUPER_USUARIO`) VALUES (15, 'Anieli de Fátima Miguel', 'anieli.miguel@ifpr.edu.br', 'ghi456*@', 'CHAVE456A', 'pendente', 0);
INSERT INTO `db_oportunif`.`TB_DOCENTE` (`ID_DOCENTE`, `NOME`, `EMAIL`, `SENHA`, `CHAVE`, `SITUACAO`, `SUPER_USUARIO`) VALUES (16, 'Anny Mirleni Almeida Silva', 'anny.silva@ifpr.edu.br', 'jkl789$%', 'CHAVE789A', 'pendente', 0);
INSERT INTO `db_oportunif`.`TB_DOCENTE` (`ID_DOCENTE`, `NOME`, `EMAIL`, `SENHA`, `CHAVE`, `SITUACAO`, `SUPER_USUARIO`) VALUES (17, 'Aryel Marlus Repula de Oliveira', 'aryel.oliveira@ifpr.edu.br', 'mno012&!', 'CHAVE012A', 'pendente', 0);
INSERT INTO `db_oportunif`.`TB_DOCENTE` (`ID_DOCENTE`, `NOME`, `EMAIL`, `SENHA`, `CHAVE`, `SITUACAO`, `SUPER_USUARIO`) VALUES (18, 'Atila de Paiva Teles', 'atila.teles@ifpr.edu.br', 'pqr345!#', 'CHAVE345A', 'pendente', 0);
